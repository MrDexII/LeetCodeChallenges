...
public class Trebuchet {
    ...
    public static void main(String[] args) {
        String data = """
                ...
                sevenbsixsbzmone55
                """;
        int calibrationValuesSum = findCalibrationValues(data);
    ...
    private static int findNumber(String singleLineString) {
        ...
        for (int i = 0; i < singleLineString.length(); i++) {
            if (!Character.isDigit(singleLineString.charAt(i))) {
                continue;
            }
            number = String.valueOf(singleLineString.charAt(i));
            break;
        }
        for (int i = singleLineString.length() - 1; i >= 0; i--) {
            if (!Character.isDigit(singleLineString.charAt(i))) {
                continue;
            }
            number += String.valueOf(singleLineString.charAt(i));
